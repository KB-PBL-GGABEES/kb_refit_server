...
DROP TABLE IF EXISTS
    personalBadge, personalWalletBrand, walletBrand, badge, receipt_process, hospital_process,
...
INSERT INTO user (username, password, role, name, birth_date,
                  total_carbon_point, total_star_point, created_at, updated_at)
VALUES ('admin', '$2a$10$FBBE8Dn1aJlA.pLEjbpyke9h0GlM8yvobq.xGVkdmC2DqLTG6zwqW',
...
(
    ...
    sicked_date         DATETIME             DEFAULT NULL,
...
CREATE TABLE personalWalletBrand
(
    personalWallet_brand_id BIGINT   NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
-- 스타벅스, 브네
INSERT INTO company (company_id, ceo_id, company_name, ceo_name, address, opened_date, created_at, updated_at,
                     category_id)
VALUES (1, 1, '스타벅스', '김대표', '서울시 중구', '2022-01-01', CURDATE(), CURDATE(), 2),
       (2, 1, '브네', '김대표', '서울시 강남구', '2022-01-01', CURDATE(), CURDATE(), 2),
       (3, 1, '이디야커피', '이대표', '서울시 영등포구', '2023-03-01', CURDATE(), CURDATE(), 2),
       (4, 1, '투썸플레이스', '박대표', '서울시 마포구', '2024-01-15', CURDATE(), CURDATE(), 2),
       (5, 1, '컴포즈커피', '최대표', '서울시 성동구', '2022-09-12', CURDATE(), CURDATE(), 2);

INSERT INTO receipt (receipt_id, total_price, supply_price, surtax, transaction_type, created_at, updated_at,
                     company_id, user_id)
VALUES (1, 5900, 5364, 536, 'CARD', '2025-07-13 14:10:00', NOW(), 1, 1),
       (2, 32500, 29545, 2955, 'CARD', '2025-07-09 19:59:00', NOW(), 2, 1),
       (3, 52500, 47727, 4773, 'CARD', '2025-07-09 19:59:00', NOW(), 2, 1),
       (4, 52500, 47727, 4773, 'CARD', '2025-06-09 15:10:00', NOW(), 2, 1),
...
-- 영수처리 내역
INSERT INTO receipt_process (receipt_process_id, process_state, ceo_id, progress_type,
...
-- 상품 내역
insert into merchandise (merchandise_name, merchandise_price, company_id)
values ('카페 아메리카노', 4100, 1);
insert into merchandise (merchandise_name, merchandise_price, company_id)
values ('카페 라떼', 4500, 1);


-- 보험
INSERT INTO insurance (insurance_id, insurance_name, joined_date, user_id)
VALUES (1, 'A보험', '2020-01-01', 1),
       (2, 'B보험', '2020-02-01', 1),
       (3, 'C보험', '2020-03-01', 1),
       (4, 'D보험', '2020-04-01', 1);

-- 병원영수증 처리요청
INSERT INTO hospital_process (process_state, sicked_date, receipt_id, insurance_id)
VALUES ('none', '2025-07-10', 1, 1),
       ('accepted', '2025-07-11', 2, 2),
       ('rejected', '2025-07-12', 3, 3),
       ('inProgress', '2025-07-13', 4, 4);

SELECT hospital_process_id, process_state, sicked_date, receipt_id, insurance_id
FROM hospital_process
