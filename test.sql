...
(
    receipt_process_id BIGINT      NOT NULL PRIMARY KEY,
...
(
    merchandise_id    BIGINT       NOT NULL PRIMARY KEY,
...
(
    receipt_content_id BIGINT   NOT NULL PRIMARY KEY,
...
(
    hospital_process_id BIGINT AUTO_INCREMENT PRIMARY KEY,
    process_state       VARCHAR(20) NOT NULL DEFAULT 'none' CHECK (
        process_state IN ('accepted', 'rejected', 'inProgress', 'none')),
...
(
    personal_badge_id BIGINT   NOT NULL PRIMARY KEY,
...
(
    personWallet_brand_id BIGINT   NOT NULL PRIMARY KEY,
...
INSERT INTO company (company_id, ceo_id, company_name, ceo_name, address, opened_date, created_at, updated_at,
                     category_id)
VALUES (1, 1, '스타벅스', '김대표', '서울시 중구', '2022-01-01', CURDATE(), CURDATE(), 1),
