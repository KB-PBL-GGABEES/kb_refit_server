...
#### 📝 프로젝트 후기
프로젝트 시작 전 경험이 부족해서 걱정이 많았던 게 엊그제 같은데 벌써 프로젝트를 마무리할 때가 되었네요. 좋은 변수명과 엔트포인트에 대해 고민하면서 협업의 기초부터 시작해 Spring과 MyBatis까지, 많은 것을 배워가는 시간이었습니다. 좀 더 나은 개발자가 될 수 있도록 많이 도와주고 자신감 불어넣어 준 팀원들 너무 고마워요. 다음에는 진짜 더 잘할 수 있는데! 우리 또 같이 해요... 즐거웠습니다 😆
...
#### 🐞 이슈 트래킹 기록
https://velog.io/@ezzangs/Refit-백엔드-개발-트러블슈팅


#### 트러블 슈팅 요약
- DB, Backend 시차 수정을 위한 UTC 시간 보정
- 커서 기반 페이지네이션 개발
- 데이터베이스 안에 쿼리문을 넣어 유동적으로 사용하기
...
특히 Refit 팀에서 병원 영수증의 전반적인 기능과 실손 보험 청구, 영수 처리 요청 등 핵심 기능을 담당하면서, 사용자가 더 편리하게 서비스를 이용할 수 있도록 고민했던 경험이 인상 깊었습니다. 
 ...
 단순히 기술적인 부분만 고민하는 것이 아닌 사용자 경험을 고려하며 팀원들과 활발히 소통하고 머리를 맞대며 고민하며 해결해 나갔던 경험의 시간들이 저에게는 큰 성장 동력이 되었습니다. (refit팀원들 다들 너무 감사했습니다!😊)
