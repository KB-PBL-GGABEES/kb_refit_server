...
#### 📝 프로젝트 후기
프로젝트 시작 전 경험이 부족해서 걱정이 많았던 게 엊그제 같은데 벌써 프로젝트를 마무리할 때가 되었네요. 좋은 변수명과 엔드포인트에 대해 고민하면서 협업의 기초부터 시작해 Spring과 MyBatis까지, 많은 것을 배워가는 시간이었습니다. 좀 더 나은 개발자가 될 수 있도록 많이 도와주고 자신감 불어넣어 준 팀원들 너무 고마워요. 다음에는 진짜 더 잘할 수 있는데! 우리 또 같이 해요... 즐거웠습니다 😆
